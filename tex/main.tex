    ...
    \begin{itemize}
      ...
      \item recepcjonista powinien mieć wgląd w historie gościa:
        \begin{itemize}
          ...
          \item uwagi
        \end{itemize}
      \item system powinien wyświetlać przyjeżdżających gości w danym dniu
      \item system powinien wyświetlać wyjeżdżających gości w danym dniu
      \item system powinien wyświetlać gości aktualnie odbywających pobyt
      \item system powinien umożliwiać wyszukiwanie gościa
      ...
      \item możliwość wydruku potwierdzenia rezerwacji
      \item możliwość wystawienia rachunku za pobyt
      \item możliwość wydruku rachunku za pobyt
      \item możliwość rozdzielenia należności za pobyt i usługi na oddzielne rachunki
      \item 
    \end{itemize}
