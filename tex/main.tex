...
zapewni grupie specjalne dodatkowe stanowisko obsługi w recepcji dostępne 
...
To klient, który skorzystał np. z usług biura turystycznego. Na rezerwacji 
...
elementów. Potencjalne składowe to:
\begin{itemize}
