...
\subsection{Historia hotelarstwa} 

\subsection{Pojęcie usługi hotelarskiej}

TODO powołać się na ustawę

\subsection{Kategoryzacja hoteli}

\subsection{Kategoryzacja usług hotelarskich}   

\subsection{Ważne definicje} 
...
nadchodzi dzień przyjazdu i rezerwacja ma stan \emph{Check-in}. Gdy przyjeżdzamy
...
wiadomości elektronicznych w celu ułatwienia komunikacji pomiedzy różnymi systemami z
branży turystycznej. OpenTravel jest złożone z firm reprezentujących linie
lotniczne, wypożyczalnie samochodów, hotele, linie żeglugowe, firmy techniczne i
...
dostoswać jeśli mamy konkurować na rynku światowym z innymi hotelami. Jest to
sposób na integracje całego spektrum biznesów branży turystycznej. Napisałem o
tej ogranizacji dlatego, żeby wskazać jej istnienie i to, że należało by je brać
